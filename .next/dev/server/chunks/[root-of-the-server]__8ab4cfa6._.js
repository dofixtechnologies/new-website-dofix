...
async function sitemap() {
    ...
    const servicePages = [
        {
            url: `${BASE_URL}/ac-repair`,
            lastModified: new Date(),
            changeFrequency: "weekly",
            priority: 0.9
        },
        {
            url: `${BASE_URL}/washing-machine-repair`,
            lastModified: new Date(),
            changeFrequency: "weekly",
            priority: 0.9
        },
        ...
        {
            url: `${BASE_URL}/microwave-repair`,
            lastModified: new Date(),
            changeFrequency: "weekly",
            priority: 0.9
        },
        {
            url: `${BASE_URL}/plumbing-services`,
            lastModified: new Date(),
            changeFrequency: "weekly",
            priority: 0.9
        },
        ...
        {
            url: `${BASE_URL}/carpenter-services`,
            lastModified: new Date(),
            changeFrequency: "weekly",
            priority: 0.9
        },
        {
            url: `${BASE_URL}/painting-services`,
            lastModified: new Date(),
            changeFrequency: "weekly",
            priority: 0.9
        }
    ...
    const cityPages = [
        ...
        {
            url: `${BASE_URL}/ghaziabad`,
            lastModified: new Date(),
            changeFrequency: "weekly",
            priority: 0.8
        },
        {
            url: `${BASE_URL}/greater-noida`,
            lastModified: new Date(),
            changeFrequency: "weekly",
            priority: 0.8
        }
