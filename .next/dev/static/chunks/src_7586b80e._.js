...
const Signin = ()=>{
    ...
    // ✅ VERIFY FUNCTION INSIDE COMPONENT
    const handleVerify = ()=>{
        const enteredOtp = otp.join("");
        if (enteredOtp.length === 4) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginUser"])();
            router.push("/account");
        }
    };
...
_s(Signin, "tZD9as/cDimtNEXfO6IvscGThaY=", false, function() {
    return [
...
//# sourceMappingURL=src_7586b80e._.js.map