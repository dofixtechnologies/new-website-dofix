          ...
          <div className="bg-white w-full rounded-2xl shadow-lg p-6 sm:p-10 lg:p-16">
            ...
            <p className="text-gray-600 text-base sm:text-5 leading-relaxed mb-6 -mt-10">
              ...
              HomeTriangle's privacy policy ("Privacy Policy" or "Policy"). Dofix Technologies Pvt Ltd and its
               ...
               solutions to facilitate connections between customers that seek specific services and service professionals 
               that offer these services. This Policy outlines our practices in relation to the collection, storage, usage,
                processing, and disclosure of personal data that you have consented to to share with us when you access, use,
                 or otherwise interact with our website available at https://dofix.in or mobile application ‘Dofix’ 
                 (collectively, “Platform”) or avail products or services that Dofix offers you on or through the Platform 
                 (collectively, the “ Services”).In this Policy, the services offered to you by service professionals on or
                  through the Platform are referred to as “ Professional Services”. At Dofix, we are committed to protecting you
                At Dofix, we are committed to protecting your personal data and respecting your privacy. In order to provide you
                 with access to the Services or the Professional Services, we have to collect and otherwise process certain 
                 data about you. This Policy explains how we process and use personal data about you. Please note that unless 
                 specifically defined in this Policy, capitalised terms shall have the same meaning ascribed to them in our 
                 Terms and Conditions, available at https://dofix.in/terms (“ Terms”). Please read this Policy in consonance 
                 with the Terms. By using the Services, you conf
                
                By using the Services, you confirm that you have read and agree to be bound by this Policy and consent to 
                the processing activities described under this Policy. Please refer to Section 1 to understand how the terms 
...
<br></br>
(b) By submitting your information and personal data to us, you agree to the transfer, storage, and processing of such information and personal data in the manner described above.</p>
</div>
...
(b) We encourage you to periodically review this Policy for the latest information on our privacy practices.
      ...
      <div className="mb-8">
              ...
              <p className="text-gray-600 leading-relaxed">
If you have any questions about this Policy, how we process or handle your personal data, or otherwise, you may reach out to us, with your queries, grievances, feedback, and comments at contact@dofix.in
</p>
</div>
